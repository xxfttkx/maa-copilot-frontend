...
import { patchChara } from 'store/characterNames'
...
export const CharaUploader: ComponentType = withSuspensable(() => {
    ...
    <DrawerLayout
      title={
        <>
          ...
          <span className="ml-2 mr-4">上传已有干员数据</span>
        </>
      }
    >
      <div className="h-full overflow-auto py-4 px-8 pt-8 mr-0.5 leading-relaxed">
        ...
        <p>
          可通过maa的小工具获取已有干员的json文件
        </p>

        <FormGroup
          className="mt-4"
          label={<span className="font-bold">选择文件</span>}
          labelFor="file-input"
          labelInfo="仅支持 .json 文件，别多选"
        >
          <FileInput
            large
            fill
